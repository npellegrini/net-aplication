...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="grdUsuarios" runat="server" AutoGenerateColumns="False" DataSourceID="odsUsuarios" ShowFooter="True" OnRowCommand="grdUsuarios_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Id" SortExpression="Id">
                        ...
                        <FooterTemplate>
                            <asp:Button ID="btnInsertar" runat="server" Text="Insertar" CommandName="Insertar" />
                        </FooterTemplate>
                        <ItemTemplate>
